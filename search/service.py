...
between web/views/ (HTMX) and web/api/views.py (Django Ninja).
"""
...
from accounts.access import allowed_edition_names
from core.models import CorpusCurrency, SearchHistory
from data.part_applicability import DEFAULT_AREA_UNIT, Building, coerce_building
from data.search_limits import CLOSE_MATCH_THRESHOLD, coerce_match_threshold
from search.engine import execute_search
from search.formatters.formatters import format_search_results
from search.llm.llm_parser import parse_user_query
    ...
    *,
    ...
    Args:
        ...
        building: What the reader told us about their building —
            ...
            ``search.llm.llm_parser``).  Ranking only: the orchestrator prefers the
    ...
    try:
        ...
        # back to the search that produced them — see telemetry.events.
