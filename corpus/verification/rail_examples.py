...
The attestation rail (``corpus.verification.verification.rail_geometry`` →
...
from corpus.verification.verification import ConsolidationRef, RailStatus, rail_geometry
