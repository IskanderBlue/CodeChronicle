...
from corpus.cross_refs import assign_occurrences
...
class Command(BaseCommand):
    ...
    #:
    #: Without the row, `search.engine.orchestration` resolves the searcher's
    ...
    def _check_in_force_overlaps(
        ...
        and the search grouping (:func:`search.engine.orchestration._group_transitions`)
    ...
    def _load_cross_references(
        ...
        surface text.  That path is lossy — see ``corpus.cross_refs`` — and dies
