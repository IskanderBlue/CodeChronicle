...
path and :func:`accounts.access.edition_allowed` never runs on an image.  The
...
cannot survive the conditional responses in :mod:`web.http_cache` — a crawler
...
from data.assets import SIGNED_PREFIXES
