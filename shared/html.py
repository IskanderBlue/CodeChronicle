...
Two callers need it and must agree, because they compose: ``corpus.cross_refs``
locates a citation's character offsets in the *text* of a version's html, and
``search.formatters.formatters`` wraps those same texts in ``<mark>`` and in diff spans.  A
