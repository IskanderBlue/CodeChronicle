...
``data.query_keywords`` is a vendored copy of CCM's word pass.  Vendored, not
...
from data.query_keywords import (
    KEYWORD_SET,
    STOPWORDS,
    plural_variants,
    tokenize,
...
class TestNoDriftFromCCM:
    ...
    def test_the_id_pass_is_the_only_difference(self) -> None:
        ...
        # ``search.llm.llm_parser``'s reference channel, which scores it against a
