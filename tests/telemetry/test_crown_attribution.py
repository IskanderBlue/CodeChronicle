...
from telemetry.attribution import crown_years_for_editions, crown_years_for_provisions
...
class TestTheReadingSurfaces:
    ...
    def test_the_edition_contents_page_carries_it(self):
        ...
        self._assert_carries(
            self.client.get(reverse("web:edition_contents", args=[edition.code_name]))
        )
    ...
    def test_the_amendment_chain_carries_it(self):
        ...
        self._assert_carries(
            self.client.get(reverse("web:edition_chain", args=[edition.pk]))
        )
