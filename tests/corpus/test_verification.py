"""Tests for ``corpus.verification.verification.derive_status`` — the per-(provision, date) rank.
...
from corpus.verification.verification import BaseInput, build_rail, derive_status
