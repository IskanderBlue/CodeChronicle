...
id order.  Item 5 of ``tasks/complete/reading-ledger-for-the-website.md``.
...
from corpus.subtrees import CONTENTS_THRESHOLD
from telemetry.events import arrival_context
...
class TestArrival:
    ...
    def test_another_page_of_ours_names_its_route(self):
        assert self._classify("http://testserver" + reverse("web:search")) == {
            "arrival": "internal",
            "from": "search",
        }
