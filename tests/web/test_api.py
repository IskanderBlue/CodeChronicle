...
from web.api.views import _extract_search_params_from_request
...
class TestApiEndpoints:
    ...
    @patch("web.api.views.connection.cursor")
    ...
    @patch("search.service.parse_user_query", autospec=False)
    @patch("search.service.execute_search", autospec=False)
    @patch("search.service.format_search_results", autospec=False)
