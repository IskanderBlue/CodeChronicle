"""Free-tier content gate (accounts.access) — helpers and gated surfaces.
...
from accounts.access import allowed_edition_names, edition_allowed, user_is_unrestricted
