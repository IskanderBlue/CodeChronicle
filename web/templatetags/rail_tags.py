...
Exposes the precomputed legend data (``corpus.verification.rail_examples``) to templates so the
...
from corpus.verification.rail_examples import LEGEND_RAILS, SYMBOL_KEY
