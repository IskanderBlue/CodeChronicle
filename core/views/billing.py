...
``core.teams`` owns what an organization is and who may join it.  This module
...
from core.teams import access_membership, organization_for_checkout
...
def create_checkout_session(request):
    ...
    #   the mirrored row `core.pricing` reads would have no figure in it.  The
    #   page would print no price, or the repo would have to hold a literal —
    #   which is the one thing `core.pricing` exists to prevent.
    #
